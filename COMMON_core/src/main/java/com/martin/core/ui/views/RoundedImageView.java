...
public class RoundedImageView extends ImageView {
	...
	public void setImageResourceAndText(int resId, String text) {
		if (mResource != resId) {
			mResource = resId;
			mText = text;
			mDrawable = resolveResourceWithText();
			updateDrawableAttrs();
			super.setImageDrawable(mDrawable);
		}
	}
	...
	private Drawable resolveResourceWithText() {
		Resources rsrc = getResources();
		if (rsrc == null) {
			return null;
		}
		...
		return RoundedDrawable.fromDrawable(d, true, mText);
	}
