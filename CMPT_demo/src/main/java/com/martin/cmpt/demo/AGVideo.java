...
import com.martin.cmpt.demo.view.LoadingView;
import com.martin.cmpt.demo.view.PlayAndPauseView;
import com.martin.core.jzvd.JZDataSource;
import com.martin.core.jzvd.JZUtils;
...
//            quickRetreat.setVisibility(VISIBLE);
    ...
    private void updateConfigChanged(int state) {
        ...
        if (state == Jzvd.SCREEN_FULLSCREEN) {
            StatusBarUtils.setNoTranslucentForImageView((Activity) getContext(), 0, findViewById(R.id.layout_top));
            ll_top.setBackgroundResource(R.drawable.jz_title_bg);
            ll_bottom.setBackgroundResource(R.drawable.jz_bottom_bg);
        } else {
            StatusBarUtils.setTranslucentForImageView((Activity) getContext(), 0, findViewById(R.id.layout_top));
